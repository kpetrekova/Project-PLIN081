...
output_file_path = 'data/combined_texts4.txt'
...
# Save the combined content to a single .txt file
output_file_path = 'data/combined_texts2.txt'
with open(output_file_path, 'w', encoding='utf-8') as f:
    f.write(combined_content)
...
content = remove_paragraph_starting_with(content, start_sentence)
#print(content)
output_file_path = 'data/combinedtexts2_withoutebooks'
with open(output_file_path, 'w', encoding='utf-8') as f:
    f.write(content)
...
output_file_path = 'data/combinedtexts2_handclean_removedfootnotes'
with open(output_file_path, 'w', encoding='utf-8') as f:
...
output_file_path = 'data/Shakespeare_utf8.txt'
